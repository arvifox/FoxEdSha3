package com.arvifox.libed.ed25519.math.bigint;

import java.io.Serializable;
import java.math.BigInteger;
import com.arvifox.libed.ed25519.math.Field;
import com.arvifox.libed.ed25519.math.FieldElement;
...
public class BigIntegerFieldElement extends FieldElement implements Serializable {
  ...
  public FieldElement subtract(FieldElement val) {
    return new BigIntegerFieldElement(f, bi.subtract(((BigIntegerFieldElement) val).bi))
        .mod(f.getQ());
  }
  ...
  public FieldElement multiply(FieldElement val) {
    return new BigIntegerFieldElement(f, bi.multiply(((BigIntegerFieldElement) val).bi))
        .mod(f.getQ());
  }
  ...
  public FieldElement modPow(FieldElement e, FieldElement m) {
    return new BigIntegerFieldElement(f,
        bi.modPow(((BigIntegerFieldElement) e).bi, ((BigIntegerFieldElement) m).bi));
  }
